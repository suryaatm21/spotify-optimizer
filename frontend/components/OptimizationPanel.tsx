      ...
      <div className="bg-spotify-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-spotify-gray-700">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-spotify-gray-400">
            No optimization suggestions available. Analyze the playlist to get
            recommendations.
          </p>
        </div>
      </div>
              ...
              <div className="flex items-start space-x-3 flex-1">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-2">
                    <h3
                      className={`font-medium ${getSuggestionTypeColor(
                    ...
                    <div className="flex items-center space-x-1">
                      <span className="text-xs text-spotify-gray-500">
                        Confidence:
                      </span>
                      <span
                  ...
                  {expandedSuggestions.has(index) && (
                    <div className="mt-3 pt-3 border-t border-spotify-gray-600">
                      ...
                      <div className="text-xs text-spotify-gray-500">
                        Track IDs:{' '}
                        {suggestion.affected_tracks.slice(0, 5).join(', ')}
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <span
            className={`font-medium ${getConfidenceColor(
              suggestions.reduce((acc, s) => acc + s.confidence_score, 0) /
                suggestions.length,
            )}`}>
            {Math.round(
              (suggestions.reduce((acc, s) => acc + s.confidence_score, 0) /
