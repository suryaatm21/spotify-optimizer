...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (token && !user && !authLoading) {
        console.warn(
          'Warning: Token exists but user is null. Token might be invalid or expired.',
        );
      }
    }
  }, [user, authLoading]);
  ...
  } = useSWR<IPlaylist[]>(user ? '/api/analytics/playlists' : null, fetcher);
          ...
          <div className="max-w-md w-full space-y-8 p-8">
            <div className="text-center">
              ...
              <p className="text-spotify-gray-300 mb-8">
                Analyze and optimize your Spotify playlists with machine
